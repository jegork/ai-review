...
- **GitHub + Azure DevOps + local CLI** — webhook server for GitHub, pipeline task for Azure DevOps, a drop-in GitHub Action, or a `rusty-bot` CLI that runs reviews against any local git repo
